...
theme.wallpaper                                 = theme.confdir .. "/wall_river.jpg"
theme.font                                      = "DIN Pro 10"
...
theme.weather = lain.widget.weather({
    ...
    notification_preset = { font = "Hasklig 10", fg = theme.fg_normal },
...
function theme.at_screen_connect(s)
    ...
    s.mybottomwibox = awful.wibar({ position = "bottom", screen = s, border_width = 0, height = 32, bg = theme.bg_normal, fg = theme.fg_normal })
